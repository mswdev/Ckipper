...
# Verifies that _ckipper_worktree_parse_args sets the correct W_* globals.
...
# Helper: source args.zsh, call _ckipper_worktree_parse_args with provided args, then print
